...
@class ARFilter;
@class ARQuaternionWeightedMovingAverageFilter;
...
@interface ARDerivativeSmoothQuaternionFilter : ARQuaternionFilter {
	ARQuaternionWeightedMovingAverageFilter *derivativeAverageFilter; // The filter that averages the derivative. Increasing this value gives a smoother value, but a larger delay.
